...
Ext.define('LoginRegister.view.MainView', {
    //extend: 'Ext.container.Viewport',		removed this coz, this covers entire desktop if align: 'stretch'. Window can be used too.
    ...
    items: [
        {
            ...
            items: [
                ...
                },
                {
					...
					name: 'profession',
					store: ['Educator', 'Employee', 'Self-Employed',  'Student'],
                    validator: function(val) {
                       if (!Ext.isEmpty(val)) {
                        return true;
                        }
